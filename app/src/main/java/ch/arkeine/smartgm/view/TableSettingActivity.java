...
import ch.arkeine.smartgm.presenter.TableSettingActivityPresenter;
import ch.arkeine.smartgm.view.adapter.TableItemAdapter;

import static ch.arkeine.smartgm.Constants.getOrDefault;

public class TableSettingActivity extends DataEditionActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setLayoutStub(R.layout.content_table_setting);
        ...
        if (presenter == null)
            presenter = new TableSettingActivityPresenter(new TableDAO(this));
    ...
    private void displayItemOption(final int position) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TableSettingActivity.this);
    ...
    private static TableSettingActivityPresenter presenter;
