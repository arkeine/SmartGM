...
public class TimelineDao extends AbstractDao<Timeline, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Fk_game_id = new Property(4, Long.class, "fk_game_id", false, "FK_GAME_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TIMELINE\" (" + //
                ...
                "\"FK_GAME_ID\" INTEGER);"); // 4: fk_game_id
    }
    ...
    public Timeline readEntity(Cursor cursor, int offset) {
        Timeline entity = new Timeline( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4) // fk_game_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Timeline entity, int offset) {
        ...
        entity.setFk_game_id(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
     }
