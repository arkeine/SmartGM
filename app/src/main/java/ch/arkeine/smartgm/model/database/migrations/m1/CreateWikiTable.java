 ...
 *
 * This migration will create a new table which represent a wiki page
 */
public final class CreateWikiTable implements DataBaseMigration {
    ...
    public static final String[] columnNameOrder(){
        return new String[]{
                COLUMN_ID, COLUMN_UNIVERSE, COLUMN_NAME, COLUMN_DESCRIPTION};
    }
