...
public class TableDao extends AbstractDao<Table, Long> {
    ...
    */
    ...
    private Query<Table> universe_TablesQuery;
    ...
    @Override
    protected void attachEntity(Table entity) {
    ...
    /** Internal query to resolve the "tables" to-many relationship of Universe. */
    public List<Table> _queryUniverse_Tables(Long fk_universe_id) {
        synchronized (this) {
            if (universe_TablesQuery == null) {
                QueryBuilder<Table> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Fk_universe_id.eq(null));
                universe_TablesQuery = queryBuilder.build();
            }
        }
        Query<Table> query = universe_TablesQuery.forCurrentThread();
